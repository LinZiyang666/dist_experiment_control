...
// origin: internal/natsreconcile/reconcile_test.go — moved into this package by B5's three-package
// merge (natsreconcile + natscluster + natsconf -> natsconf). See docs/reviews/batch-b2-plan.md §2.1.
