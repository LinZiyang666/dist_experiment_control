...
RC=0
for t in poll-reentrancy-test verdict-contract-test validate-verdicts validate-verdicts-selftest deviation-report-test poll-mode-test simcluster-accel-external-review-test simcluster-accel-external-rereview-test simcluster-accel-final-review-test lint-drills lint-install ledger-crosscheck r9d-nonvacuity kept-sites-selftest; do
    printf '%-24s ' "$t"
