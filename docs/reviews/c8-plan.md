...
> Implements `docs/reviews/v2-cli-consolidation-proposal.md` — the delete-as-you-build that C3–C6 skipped. CLI-surface phase: favor deletion over abstraction, never weaken a gate, never leave a live dual surface. Ground truth re-verified for every decision below (file:line cited).
